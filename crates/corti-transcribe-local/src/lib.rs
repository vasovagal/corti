...
//! me-vs-them split is just the channel: ch0 → [`Speaker::Me`]. The far-end channel (ch1) is further
//! diarized (pyannote-segmentation-3.0 + 3D-Speaker embedding, both ONNX) into `Them 1/2/…`.
//!
...
impl Transcriber for LocalTranscriber {
    fn transcribe(&self, audio: &Path, _meta: &RecordingMeta) -> Result<DiarizedTranscript> {
        ...
        // ch1 (system tap) → far-end speakers. Diarize and attribute each word to its speaker turn.
