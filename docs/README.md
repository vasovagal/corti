...
| [transcription.md](transcription.md) | The `Transcriber` trait, local Parakeet (sherpa/CPU or transcribe.cpp/Metal) and AWS backends, the queue + durable jobs, crash-safe live inbox filing, and vagus filing. |
